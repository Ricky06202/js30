...
const bornedIn1500s = inventors.filter(
...
const orderByAge = inventors.sort((a, b) => (a.year > b.year ? 1 : -1))

orderByAge

// Array.prototype.reduce()
// 4. How many years did all the inventors live all together?
const inventorsTotalAge = inventors.reduce((total, inventor) => {
...
const sortByLastName = people.sort((a,b) => {
  // const lastA = a.split(', ').at(0)
  // const lastB = b.split(', ').at(0)
